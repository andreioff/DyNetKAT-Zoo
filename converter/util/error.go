...
const (
	...
	ErrNoContWithGivenId              = "No controller matches the given id '%d'"
	...
	ErrArrayLenMustMatchEdgesNo       = "Array length must match the number of edges!"
	ErrNoEdgeCostFound                = "Could not find new cost for edge (%d, %d)!"
	ErrMaxCostChangingAttemptsReached = "Failed to extract new host communication paths after attempting %d times to change link costs!"
)
